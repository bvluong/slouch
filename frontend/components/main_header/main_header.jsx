    ...
    <div className="main-header">
      <div className="left-main-header">
        ...
        <section className="main-header-detail">
          ...
          <span> <img src="http://res.cloudinary.com/djrgebhxz/image/upload/v1495582280/nyanparrot_khcpab.gif"/>
            {description} <img src="http://res.cloudinary.com/djrgebhxz/image/upload/v1495578902/partyparrot_dtebhb.gif" /> </span>
        </section>
      </div>
